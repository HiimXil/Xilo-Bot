...
CREATE TABLE "new_Wordle" (
    ...
    "letterUsed" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_Wordle" ("channel", "discordId", "guildId", "letterUsed", "resultSaved", "tryCount") SELECT "channel", "discordId", "guildId", "letterUsed", "resultSaved", "tryCount" FROM "Wordle";
DROP TABLE "Wordle";
